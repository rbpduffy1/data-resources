...
```{r}
data <- read.csv('classification_data.csv')
...
confusionMatrix(data = Predict_info, reference = test$decision)
```
...
implement$prediction <- predict(model_info, implement, type = "class")
